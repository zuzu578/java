...
public class JavaNew {
	...
	//3) ex 카페라떼 4000 카푸치노 4천 아메리카노 3천 에스프레소 2500  4.얼그레이 25백	
		...
		ArrayList <Integer>alOrder = new ArrayList<Integer>();// 주문을 저장
		ArrayList<Integer> alCount =new ArrayList<Integer>() ; //수량을 저장
		ArrayList <Integer>alExpanse =new ArrayList<Integer>();//가격저장//
		ArrayList<String>menu1 = new ArrayList<String>(); // 메뉴 저장 //
		         ...
		         String [] menu = {"1.카페라떼4천원 ","2.카푸치노3천원","3.아메리카노2천원","4.얼그레이2천500원"};
		            //---> 커피 가격 저장 <----//  
					         ...
					         System.out.println("메뉴를 선택하려면 아무숫자를 엔터해주세요 .취소는 0");
					          int n = sc4.nextInt();
					         while(n>0){
